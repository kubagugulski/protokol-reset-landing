      ...
      <main className="pt-32 px-6 max-w-3xl mx-auto">
        <div className="border border-gray-800 bg-[#0a0a0a] p-8 md:p-12 relative overflow-hidden">
          ...
          <p className="mb-4 text-stone-700">
            Administratorem danych osobowych protokolreset.pl jest firma Jakub Gugulski, Ratajów 30, 32-090 Słomniki, NIP: 6821811984.
          </p>
          ...
          <p className="mb-4 text-stone-700">
            Dane nie są przetwarzane przez osoby trzecie. Dane przechowywane są przez serwis https://protokolreset.pl/
          </p>
